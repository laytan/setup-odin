 ...
 * @return {string}
 */
export function mainCacheKey(i) {
 ...
 * @return {string}
 */
export function darwinCacheKey(inputs) {
 ...
 * @return {string[]}
 */
export function darwinCachePaths(inputs) {
